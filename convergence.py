...
def convergence(u_vel, u_coeff, v_vel, v_coeff, pressure, u_ref, dx, dy, rho, L):
    ...
    numerator = numerator - (Aw_u*u_vel[1:-2][:-3] + Ae_u*u_vel[1:-2][2:] + As_u*u_vel[:-3][1:-2] + An_u*u_vel[2:][1:-2])
    ...
    numerator = numerator - (Aw_v*v_vel[1:-2][:-3] + Ae_v*v_vel[1:-2][2:] + As_v*v_vel[:-3][1:-2] + An_v*v_vel[2:][1:-2])
